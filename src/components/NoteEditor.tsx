  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col h-full">
      <input
        ...
        className="w-full text-2xl font-bold px-6 py-4 bg-transparent border-b outline-none placeholder:opacity-50"
      ...
      <div className="relative flex-1 flex flex-col">
        <textarea
          ...
          className="flex-1 w-full px-6 py-4 pr-16 bg-transparent outline-none resize-none text-base leading-relaxed placeholder:opacity-50"
        ...
        <button
          ...
          className="absolute top-3 right-3 w-11 h-11 flex items-center justify-center rounded-full text-white transition-colors cursor-pointer"
          style={{
      ...
      >
        <button
          type="submit"
          disabled={!title.trim()}
          className="px-5 py-2 rounded-lg text-white font-medium transition-colors disabled:opacity-40 cursor-pointer disabled:cursor-not-allowed"
