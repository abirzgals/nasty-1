...
export default function NoteEditor({ note, onSave, onCancel }: NoteEditorProps) {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      {/* Hidden file inputs */}
      <input ref={cameraRef} type="file" accept="image/*" capture="environment" onChange={(e) => handlePhoto(e.target.files)} style={{ display: "none" }} />
      <input ref={galleryRef} type="file" accept="image/*" multiple onChange={(e) => handlePhoto(e.target.files)} style={{ display: "none" }} />
